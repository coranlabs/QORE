...
func CreateCoranlabsLogFile(file string) (string, error) {
	// Because Coranlabs log file will be used by multiple NFs, it is not recommended to rename.
