...
func verifyHandshakeSignature(sigType uint8, pubkey crypto.PublicKey, hashFunc crypto.Hash, signed, sig []byte) error {
	...
	case signatureMLDSA65, signatureEdDilithium3:
...
func signatureSchemesForCertificate(version uint16, cert *Certificate) []SignatureScheme {
	...
	case circlSign.PublicKey:
		...
		sigAlgs = []SignatureScheme{SignatureScheme(tlsScheme.TLSIdentifier())} //todo add a helper function to convert circlSign.Scheme to SignatureScheme in tls_pq.go

		// to be Removed
		// fmt.Println("circlSign.Scheme", scheme.Name(), "TLSIdentifier", tlsScheme.TLSIdentifier())
...
func selectSignatureScheme(vers uint16, c *Certificate, peerAlgs []SignatureScheme) (SignatureScheme, error) {
	...
	// to be Removed
	// fmt.Printf("Peer Algs: %v\n", peerAlgs)
	for _, preferredAlg := range peerAlgs {
		// fmt.Println("Preferred Alg:", preferredAlg.String())
