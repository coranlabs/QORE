...
// ThresholdLevel1 - Represents a threshold level.
type ThresholdLevel1 struct {
...
// AssertThresholdLevel1Required checks if the required fields are not zero-ed
func AssertThresholdLevel1Required(obj ThresholdLevel1) error {
	return nil
}

// AssertRecurseThresholdLevel1Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ThresholdLevel1 (e.g. [][]ThresholdLevel1), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseThresholdLevel1Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aThresholdLevel1, ok := obj.(ThresholdLevel1)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertThresholdLevel1Required(aThresholdLevel1)
	})
}
