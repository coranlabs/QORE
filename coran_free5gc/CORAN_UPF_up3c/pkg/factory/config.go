...
type Config struct {
	Gnbip       string    `yaml:"Gnb"         valid:"optional"`
	Gatewayip   string    `yaml:"Gateway"     valid:"optional"`
	Mode        string    `yaml:"mode"        valid:"optional"`
