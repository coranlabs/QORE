...
const (
	ScpDefaultTLSKeyLogPath      = "./log/scp.log"
	ScpDefaultCertPemPath        = "./cert/scp.pem"
	ScpDefaultPrivateKeyPath     = "./cert/scp.key"
	ScpDefaultRootCertPemPath    = "./cert/root.pem"
	ScpDefaultRootPrivateKeyPath = "./cert/root.key"
	ScpDefaultConfigPath         = "./config/CORAN_SCP.yaml"
	ScpSbiDefaultIPv4            = "0.0.0.0"
	ScpSbiDefaultPort            = 8000
	ScpSbiDefaultScheme          = "http"
	ScpDefaultNrfUri             = "http://127.0.0.10:8000"
)
...
type Configuration struct {
	...
	MongoDBUrl  string `yaml:"MongoDBUrl" valid:"optional"`
	// DefaultPlmnId   models.PlmnId `yaml:"DefaultPlmnId" valid:"required"`
	ServiceNameList []string `yaml:"serviceNameList,omitempty" valid:"optional"`
...
func (c *Config) GetSbiBindingIP() string {
	...
	if c.Configuration == nil || c.Configuration.Sbi == nil {
		log.Println("here is the error", bindIP)
		return bindIP
	}
...
func (c *Config) GetScpCertPemPath() string {
	c.RLock()
	defer c.RUnlock()
...
func (c *Config) GetScpPrivKeyPath() string {
	c.RLock()
	defer c.RUnlock()
	if c.Configuration.Sbi.Cert != nil {
...
func (c *Config) GetRootCertPemPath() string {
	...
	return ScpDefaultRootCertPemPath
}
...
func (c *Config) GetRootPrivKeyPath() string {
	...
	return ScpDefaultRootPrivateKeyPath
}
