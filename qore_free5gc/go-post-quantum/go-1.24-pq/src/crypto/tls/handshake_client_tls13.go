...
func (hs *clientHandshakeStateTLS13) establishHandshakeKeys() error {
	...
	c.config.writeKeyLog(keyLogLabelClientECDH, hs.hello.random, peerKey.Bytes()) // Log the peer's public key. -- to be removed.
	...
	c.config.writeKeyLog(keyLogLabelSharedSecretECDH, hs.hello.random, sharedKey)
	...
	if hs.serverHello.serverShare.group == X25519MLKEM768 {
		...
		c.config.writeKeyLog(keyLogLabelCipherTextKEM, hs.hello.random, ciphertext)
		...
		c.config.writeKeyLog(keyLogLabelSharedSecretKEM, hs.hello.random, mlkemShared)
